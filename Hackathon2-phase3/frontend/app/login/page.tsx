...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-white">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden bg-gradient-to-br from-primary-900 to-secondary-900">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1518837695005-2083093ee35b?q=80&w=2070&auto=format&fit=crop')] bg-cover bg-center opacity-40 mix-blend-overlay"></div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white">
          ...
          <p className="text-xl text-gray-200 max-w-lg leading-relaxed">
            Experience productivity like never before with our luxury task management suite. Organize, prioritize, and achieve your goals.
          </p>
        </div>

        {/* Decorative Circles */}
        <div className="absolute top-[-10%] right-[-10%] w-96 h-96 bg-primary-500/30 rounded-full blur-3xl"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-96 h-96 bg-secondary-500/30 rounded-full blur-3xl"></div>
      </div>
    </div>
  );
}